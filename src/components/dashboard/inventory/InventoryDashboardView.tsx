  ...
  return (
    <div className="h-full flex-1 flex flex-col min-h-0 bg-white dark:bg-slate-950 text-slate-800 dark:text-slate-100 overflow-y-auto font-sans">
      ...
      <div className="px-6 py-3 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between gap-4 bg-white dark:bg-slate-900 shrink-0 sticky top-0 z-10">
        <div>
          <h1 className="text-lg font-bold text-slate-900 dark:text-white tracking-tight leading-tight flex items-center gap-2">
            <Boxes className="size-5 text-[#0d6157] dark:text-teal-400" />
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-slate-200 dark:divide-slate-800 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shrink-0">
        ...
        <div className="px-5 py-3 flex items-center justify-between hover:bg-slate-50/50 dark:hover:bg-slate-800/40 transition-colors">
          <div className="space-y-0.5">
            <span className="block text-[10px] font-bold text-[#0d6157] dark:text-teal-400 tracking-wider uppercase">
      ...
      <div className="p-6 space-y-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="border border-slate-200/80 dark:border-slate-800 rounded-2xl bg-white dark:bg-slate-900 overflow-hidden shadow-2xs">
            <div className="px-5 py-3 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between bg-slate-50/50 dark:bg-slate-900/50">
              ...
              <Link
                ...
                className="text-[11px] font-semibold text-[#0d6157] dark:text-teal-400 hover:text-[#09433c] hover:underline flex items-center gap-0.5 transition-colors"
              >
                <span>View all</span>
            ...
            <div className="divide-y divide-slate-100 dark:divide-slate-800">
              {metrics.lowStockItems.length === 0 ? (
                <div className="p-8 text-center text-slate-400 text-xs">
                  <div className="size-12 rounded-full bg-[#e6f6f3] dark:bg-[#0d6157]/20 flex items-center justify-center mx-auto mb-2 text-[#0d6157] dark:text-teal-300">
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 shrink-0">
                        ...
                        <Link
                          ...
                          className="px-3 py-1 text-[11px] font-semibold bg-[#e6f6f3] hover:bg-[#d6f0ea] text-[#0d5c56] dark:bg-[#0d6157]/25 dark:hover:bg-[#0d6157]/40 dark:text-teal-300 rounded-[8px] border border-[#0d8276]/20 transition-all"
                        >
                          Reorder
                        </Link>
                      </div>
          ...
          <div className="border border-slate-200/80 dark:border-slate-800 rounded-2xl bg-white dark:bg-slate-900 overflow-hidden shadow-2xs">
            <div className="px-5 py-3 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between bg-slate-50/50 dark:bg-slate-900/50">
              <div className="flex items-center gap-2">
                <Activity className="size-4 text-[#0d6157] dark:text-teal-400" />
                <h3 className="text-xs font-bold text-slate-900 dark:text-white">
                      ...
                      <div className="min-w-0 pr-3">
                        <div className="flex items-center gap-2">
                          ...
                          <Link
                            ...
                            className="font-bold text-xs text-slate-900 dark:text-white hover:text-[#0d6157] dark:hover:text-teal-300 truncate"
                          >
                            {mov.item.name}
                          </Link>
                        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Link
            href="/portal/inventory/items"
            className="p-4.5 rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 hover:border-[#0d8276]/40 hover:shadow-xs transition-all flex flex-col justify-between group cursor-pointer"
          >
            <div className="flex items-center justify-between">
              <div className="size-9 rounded-[8px] bg-[#e6f6f3] dark:bg-[#0d6157]/20 text-[#0d6157] dark:text-teal-300 flex items-center justify-center border border-[#0d8276]/20">
                <Package className="size-4" />
              </div>
              <ArrowUpRight className="size-3.5 text-slate-400 group-hover:text-[#0d6157] dark:group-hover:text-teal-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all" />
            </div>
            <div className="mt-3">
              <h4 className="font-bold text-xs text-slate-900 dark:text-white group-hover:text-[#0d6157] dark:group-hover:text-teal-300 transition-colors">Items &amp; Stock</h4>
          ...
          <Link
            href="/portal/inventory/requests"
            className="p-4.5 rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 hover:border-emerald-500/40 hover:shadow-xs transition-all flex flex-col justify-between group cursor-pointer"
          >
            <div className="flex items-center justify-between">
              <div className="size-9 rounded-[8px] bg-emerald-50 dark:bg-emerald-950/60 text-emerald-600 dark:text-emerald-400 flex items-center justify-center border border-emerald-200/60 dark:border-emerald-800">
                <ClipboardList className="size-4" />
              </div>
              <ArrowUpRight className="size-3.5 text-slate-400 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all" />
            </div>
            <div className="mt-3">
              <h4 className="font-bold text-xs text-slate-900 dark:text-white group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">Item Requests</h4>
          ...
          >
            ...
            <div className="mt-3">
              <h4 className="font-bold text-xs text-slate-900 dark:text-white group-hover:text-[#0d6157] dark:group-hover:text-teal-300 transition-colors">Purchase Orders</h4>
          ...
          <Link
            ...
            className="p-4.5 rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 hover:border-amber-500/40 hover:shadow-xs transition-all flex flex-col justify-between group cursor-pointer"
          >
            <div className="flex items-center justify-between">
              <div className="size-9 rounded-[8px] bg-amber-50 dark:bg-amber-950/60 text-amber-600 dark:text-amber-400 flex items-center justify-center border border-amber-200/60 dark:border-amber-800">
                <DollarSign className="size-4" />
              </div>
              <ArrowUpRight className="size-3.5 text-slate-400 group-hover:text-amber-600 dark:group-hover:text-amber-400 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all" />
            </div>
            <div className="mt-3">
              <h4 className="font-bold text-xs text-slate-900 dark:text-white group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors">Suppliers</h4>
