...
export const i18n = {
  en: {
    ...
    more_doctors_hint: (buttonLabel: string) => `_Tap *${buttonLabel}* to see more doctors._`,
  ...
  ar: {
    ...
    more_doctors_hint: (buttonLabel: string) => `_اضغط على *${buttonLabel}* لعرض المزيد من الأطباء._`,
